...
from Tiles import Card, Chance, CommunityChest, Utility, Railroad
...
class TestAdvanceToNextUtility(unittest.TestCase):
    ...
    @patch("Tiles.get_yes_or_no_input", return_value=True)
    def test_advance_to_1st_util(self, get_yes_or_no_input):
    ...
    @patch("Tiles.get_yes_or_no_input", return_value=True)
    def test_advance_to_2nd_util(self, get_yes_or_no_input):
        # Utils on Tiles 12 & 28
