...
class TestLandedOn(unittest.TestCase):
    ...
    def test_landed_on_owned_by_bank_and_by(self, get_yes_or_no_input):
        ...
        self.assertEqual(test_player.owned_properites, {test_util.location : test_util})
    ...
    @patch("Tiles.get_yes_or_no_input", return_value = True)
    def test_landed_on_owned_by_diff_player_who_owns_one_util(self, randint, get_yes_or_no_input):
        test_util = Utility(12, correct_data())
    ...
    @patch("Tiles.randint", return_value = 5)
    @patch("Tiles.get_yes_or_no_input", return_value = True)
    def test_landed_on_owned_by_diff_player_who_owns_two_utils(self, randint, get_yes_or_no_input):
        ...
        self.assertEqual(test_player_2.owned_properites, {12 : test_util_1, 28 : test_util_2})
